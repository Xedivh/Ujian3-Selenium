...
public class QuizDragDropTest extends BaseTest{
    ...
    public void ujian3Test() throws InterruptedException {
        ...
        ScreenshotHelper.takeScreenshot("ujian3Test_before.png", driver);
        ...
        ScreenshotHelper.takeScreenshot("ujian3Test_after.png", driver);

        for (String[] pair : keyElements) {
            draggableSantui(pair[0], "dropContent"); // "dropContent" = ID div kiri
            Thread.sleep(1000);
        }

        ScreenshotHelper.takeScreenshot("ujian3Test_back.png", driver);
    }
